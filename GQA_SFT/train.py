...
class Train:
    ...
    def __call__(self):
        ...
        _, _client_states = self._engine.load_checkpoint("/root/project/My_projects/Transformer/GQA_SFT/weights/weight.pt")
        ...
        self._engine.save_checkpoint(
            save_dir=f"/root/project/My_projects/Transformer/GQA_SFT/weights/weight.pt", tag=f"sft_{_ss}",
