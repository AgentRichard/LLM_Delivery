...
if __name__ == "__main__":
    preprocess = Preprocess("/root/project/My_projects/Transformer/GQA_PEFT/tokenizer.model")
    preprocess("/root/project/My_projects/Transformer/GQA_PEFT/data/preprocess/raw_data", "/root/project/My_projects/Transformer/GQA_PEFT/data/datas")
