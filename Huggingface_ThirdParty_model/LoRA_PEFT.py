...
dataset_path = "/root/project/My_projects/MS_PEFT_RLHF_qwen_0.5B_instruct/datas/rozhiba1"
...
def dataset_preprocess(data):
    ...
    response = f"{data["response"]}<|im_end|>\n"
...
training_argument = TrainingArguments(
    output_dir = "/root/project/My_projects/MS_PEFT_RLHF_qwen_0.5B_instruct/checkpoint_lora",
